...
QVariant ConnectionsTreeModel::headerData(int section, Qt::Orientation orientation, int role) const {
    ...
    if (role == Qt::ToolTipRole) {
        switch (section) {
            case ColTarget:
                return tr("Click To Sort By Process");
            case ColSource:
                return tr("Click To Sort By Source");
            case ColProtocol:
                return tr("Click To Sort By Protocol");
            case ColOutbound:
                return tr("Click To Sort By Outbound");
            case ColTraffic:
                return tr("Click to sort by traffic; right-click to choose total/down/up");
            case ColSpeed:
                return tr("Click to sort by speed; right-click to choose total/down/up");
            default:
                return {};
        }
    }
...
void ConnectionsTreeModel::setConnections(const QList<Stats::ConnectionMetadata> &connections,
    ...
    switch (sort) {
        case Stats::ByTraffic:
            sortTree(groups, descending, [](const ProcessGroupItem &g) { return g.totalUpload + g.totalDownload; }, [](const ConnectionLeafItem &l) { return l.upload + l.download; });
            break;
        case Stats::ByDownload:
            sortTree(groups, descending, [](const ProcessGroupItem &g) { return g.totalDownload; }, [](const ConnectionLeafItem &l) { return l.download; });
            break;
        case Stats::ByUpload:
            sortTree(groups, descending, [](const ProcessGroupItem &g) { return g.totalUpload; }, [](const ConnectionLeafItem &l) { return l.upload; });
            break;
        case Stats::BySpeed:
            sortTree(groups, descending, [](const ProcessGroupItem &g) { return g.totalUploadSpeed + g.totalDownloadSpeed; }, [](const ConnectionLeafItem &l) { return l.uploadSpeed + l.downloadSpeed; });
            break;
        case Stats::ByDownloadSpeed:
            sortTree(groups, descending, [](const ProcessGroupItem &g) { return g.totalDownloadSpeed; }, [](const ConnectionLeafItem &l) { return l.downloadSpeed; });
            break;
        case Stats::ByUploadSpeed:
            sortTree(groups, descending, [](const ProcessGroupItem &g) { return g.totalUploadSpeed; }, [](const ConnectionLeafItem &l) { return l.uploadSpeed; });
            break;
        case Stats::ByProcess:
            sortTree(groups, descending, [](const ProcessGroupItem &g) -> const QString & { return g.processName; }, [](const ConnectionLeafItem &l) -> const QString & { return l.destText; });
            break;
        default:
            break;
    }
